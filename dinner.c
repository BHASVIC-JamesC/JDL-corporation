...
int main(void) {
    int run = 1;
    char data[7][12][20] = {
        {"james","cook","22/09/07","16","0","2","FB","3","N","3","cook1234"},
        {"emma","smith","10/05/92","31","1","1","BB","5","Y","1","smith2345"},
        {"liam","johnson","15/08/85","38","2","2","HB","7","N","6","johnson6789"},
        {"olivia","brown","28/11/01","22","0","1","FB","4","Y","2","brown4521"},
        {"noah","williams","04/02/95","29","1","2","FB","10","N","4","williams7890"},
        {"sophia","martin","19/07/88","35","3","2","HB","6","Y","5","martin3456"}
    };
